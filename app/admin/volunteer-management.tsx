...
export default function VolunteerManagementPage() {
  ...
  const managementOptions = [
    ...
    {
      title: 'مدیریت اطلاعات ادمین',
      subtitle: 'مشاهده، ویرایش و حذف اطلاعات مدیران',
      icon: '👨‍💼',
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.headerSection, { backgroundColor: surfaceColor, borderColor }]}>
          ...
          <ThemedText style={[styles.headerDescription, { color: textColor }]}>
            از این بخش می‌توانید اطلاعات مددجویان و مدیران سیستم را مشاهده، ویرایش و مدیریت کنید.
          </ThemedText>
        </View>
