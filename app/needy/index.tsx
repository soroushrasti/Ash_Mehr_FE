          ...
          <View style={styles.actionGrid}>
            ...
            >
              ...
              <ThemedText style={[styles.actionDescription, { color: textColor, opacity: 0.7 }]} rtl={true}>
                مشاهده جزییات اطلاعات
              </ThemedText>
            </TouchableOpacity>

            {/* plot data */}
                <TouchableOpacity
                  style={[styles.actionCard, styles.rtlActionCard, { backgroundColor: "#cffecc", borderColor }]}
                  onPress={() => router.push('/needy/verify-goods')}
                >
                  <View style={styles.actionCardHeader}>
                    <ThemedText style={[styles.actionTitle, { color: primaryColor }]} rtl={true}>
                      تایید کمک ها
                  ...
                  <ThemedText style={[styles.actionDescription, { color: textColor, opacity: 0.7 }]} rtl={true}>
                    مشاهده و تایید کمک های دریافتی
                  </ThemedText>
                </TouchableOpacity>
